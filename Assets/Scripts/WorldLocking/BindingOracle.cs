...
namespace Microsoft.MixedReality.WorldLocking.ASA
{
    ...
    /// </remarks>
    public class BindingOracle : MonoBehaviour, IBindingOracle
    {
            ...
            using (FileStream fileStream = new FileStream(GetFullPath(), FileMode.Open, FileAccess.Read))
            {
                using (StreamReader reader = new StreamReader(fileStream))
                {
                    ...
                    while (line != null)
                    {
                        ...
                        Microsoft.MixedReality.WorldLocking.Tools.SimpleConsole.AddLine(8, $"Got:{binderName}, Want:{binder.Name}, Math={isCorrectBinder}");
